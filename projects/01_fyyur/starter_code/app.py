...
def delete_venue(venue_id):
    ...
    if error:
        flash('An error occurred. Venue' + str(venue_id) +
              'could not be listed.')
    else:
...
def show_artist(artist_id):
    ...
    past_query = db.session.query(Show).join(Venue).filter(
...
def edit_artist_submission(artist_id):
    ...
    if error:
        flash('An error occurred. Artist ' + str(artist_id) +
              ' could not be listed.')
    else:
...
def create_artist_submission():
    ...
    if error:
        ...
        # on successful db insert, flash success
        flash('Artist ' + request.form['name'] + ' was sucessfully listed!')
...
def create_show_submission():
    ...
    if error:
        ...
        # on successful db insert, flash success
        flash('Show was sucessfully listed!')
    return render_template('pages/home.html')
